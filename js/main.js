let balance = 0;
let name = prompt('Please put your name in!') ;
let index_balance = document.getElementById('balance');
...
var completeTransaction = function() {
  ...
  // 3. IF the balance is less than 0, make the balance red, else make it black
        ...
        index_balance.classList.remove('green_balance');
        index_balance.classList.add('red_balance');
        }

        else {

        index_balance.classList.add('green_balance');
